...
First, this function parses the citations in the document, converting
citations marked with double at sign, e.g.: `@@reference2020`, into
normal citations, e.g.: `@reference2020`. Then, it renders the file.
