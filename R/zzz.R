...
.onAttach <- function(libname, pkgname) {
  ...
  print_message <- paste0("Welcome to WORCS: Workflow for Open Reproducible Code in Science. Please read the tutorial before using this package, and consider citing it. ",
                          ifelse(has_git(), "",
