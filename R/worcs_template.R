worcs_template <- function(path, ...) {
  ...
  # Begin readme
readme_txt <- c("# A WORCS Project", "", "This project is based on the Workflow for Open Reproducible Code in Science (WORCS). For more details, please read..."
)
  # End readme
  writeLines(readme_txt, con = file.path(path, "README.md"))

  # Begin manuscript
man_text <- c("---", "title             : \"The title\"", "shorttitle        : \"Title\"",
"", "author: ", "  - name          : \"First Author\"", "    affiliation   : \"1\"",
"    corresponding : yes    # Define only one corresponding author",
"    address       : \"Postal address\"", "    email         : \"my@email.com\"",
"  - name          : \"Ernst-August Doelle\"", "    affiliation   : \"1,2\"",
"", "affiliation:", "  - id            : \"1\"", "    institution   : \"Wilhelm-Wundt-University\"",
"  - id            : \"2\"", "    institution   : \"Konstanz Business School\"",
"", "authornote: |", "  Add complete departmental affiliations for each author here. Each new line herein must be indented, like this line.",
"", "  Enter author note here.", "", "abstract: |", "  One or two sentences providing a **basic introduction** to the field,  comprehensible to a scientist in any discipline.",
...
"  ", "  <!-- https://tinyurl.com/ybremelq -->", "  ", "keywords          : \"keywords\"",
"wordcount         : \"X\"", "", "bibliography      : [\"r-references.bib\"]",
"", "floatsintext      : no", "figurelist        : no", "tablelist         : no",
"footnotelist      : no", "linenumbers       : yes", "mask              : no",
"draft             : no", "", "documentclass     : \"apa6\"",
"classoption       : \"man\"", "output            : papaja::apa6_pdf",
"---", "", "```{r setup, include = FALSE}", "library(papaja)",
"library(worcs)", "```", "", "```{r analysis-preferences}", "# Seed for random number generation",
"set.seed(42)", "knitr::opts_chunk$set(cache.extra = knitr::rand_seed)",
"```", "", "", "", "# Methods", "We report how we determined our sample size, all data exclusions (if any), all manipulations, and all measures in the study. <!-- 21-word solution (Simmons, Nelson & Simonsohn, 2012; retrieved from http://ssrn.com/abstract=2160588) -->",
"", "## Participants", "", "## Material", "", "## Procedure",
"", "## Data analysis", "We used `r cite_r(\"r-references.bib\")` for all our analyses.",
"", "```{r}", "data <- load_data()", "```", "", "", "# Results",
"", "# Discussion", "", "", "\\newpage", "", "# References",
"```{r create_r-references}", "r_refs(file = \"r-references.bib\")",
"```", "", "\\begingroup", "\\setlength{\\parindent}{-0.5in}",
"\\setlength{\\leftskip}{0.5in}", "", "<div id = \"refs\"></div>",
"\\endgroup")
  # End manuscript
  writeLines(man_text, con = file.path(path, "manuscript.Rmd"))

  # Begin prereg
prereg <- c("---", "title           : \"My preregistration for the COS Preregistration Challenge\"",
"shorttitle      : \"My preregistration\"", "date            : \"`r Sys.setlocale('LC_TIME', 'C'); format(Sys.time(), '%d\\\\\\\\. %B %Y')`\"",
"", "author: ", "  - name        : First Author", "    affiliation : 1",
"  - name        : Ernst-August Doelle", "    affiliation : \"1,2\"",
"", "affiliation:", "  - id          : 1", "    institution : Wilhelm-Wundt-University",
"  - id          : 2", "    institution : Konstanz Business School",
"", "output: prereg::cos_prereg", "---", "", "# Study Information",
"<!-- This is a note for users of os_template. After completing this ",
"preregistration form, click the 'knit' button in Rstudio. A pdf is generated.",
"This pdf can be uploaded directly to the OSF if you follow the tutorial at",
"https://help.osf.io/hc/en-us/articles/360019738834-Create-a-Preregistration:",
"\"attach the completed template as a file to a question in the form - if you",
"choose this second option, simply enter \"see attached file\" for the questions.\"",
"-->", "", "## Title", "<!-- Provide the working title of your study. It may be the same title that you submit for publication of your final manuscript, but it is not a requirement. The title should be a specific and informative description of a project. Vague titles such as 'Fruit fly preregistration plan' are not appropriate.",
"", "Example: Effect of sugar on brownie tastiness. -->", "",
"`r rmarkdown::metadata$title`", "", "", "## Description", "<!-- Please give a brief description of your study, including some background, the purpose of the of the study, or broad research questions. The description should be no longer than the length of an abstract. It can give some context for the proposed study, but great detail is not needed here for your preregistration.",
...
"", "Enter your response here.", "", "", "## Hypotheses", "<!-- List specific, concise, and testable hypotheses. Please state if the hypotheses are directional or non-directional. If directional, state the direction. A predicted effect is also appropriate here. If a specific interaction or moderation is important to your research, you can list that as a separate hypothesis.",
"", "Example: If taste affects preference, then mean preference indices will be higher with higher concentrations of sugar. -->",
"", "Enter your response here.", "", "", "# Design Plan", "<!-- In this section, you will be asked to describe the overall design of your study. Remember that this research plan is designed to register a single study, so if you have multiple experimental designs, please complete a separate preregistration. -->",
...
"", "**Other**. Please explain.", "", "", "## Blinding", "<!-- Blinding describes who is aware of the experimental manipulations within a study. Select all that apply. Is there any additional blinding in this study? -->",
"", "No blinding is involved in this study.", "", "For studies that involve human subjects, they will not know the treatment group to which they have been assigned.",
...
"", "Enter your response here.", "", "", "## Randomization",
...
"", "Enter your response here.", "", "", "# Sampling Plan", "<!-- In this section we?\200\231ll ask you to describe how you plan to collect samples, as well as the number of samples you plan to collect and your rationale for this decision. Please keep in mind that the data described in this section should be the actual data used for analysis, so if you are using a subset of a larger dataset, please describe the subset that will actually be used in your study. -->",
"", "", "## Existing data", "<!-- Preregistration is designed to make clear the distinction between confirmatory tests, specified prior to seeing the data, and exploratory analyses conducted after observing the data. Therefore, creating a research plan in which existing data will be used presents unique challenges. Please select the description that best describes your situation. Please do not hesitate to contact us if you have questions about how to answer this question (prereg@cos.io). -->",
...
"", "", "", "## Explanation of existing data", "<!-- If you indicate that you will be using some data that already exist in this study, please describe the steps you have taken to assure that you are unaware of any patterns or summary statistics in the data. This may include an explanation of how access to the data has been limited, who has observed the data, or how you have avoided observing any analysis of the specific data you will use in your study.",
...
"", "Enter your response here.", "", "", "## Data collection procedures",
"<!-- Please describe the process by which you will collect your data. If you are using human subjects, this should include the population from which you obtain subjects, recruitment efforts, payment for participation, how subjects will be selected for eligibility from the initial pool (e.g. inclusion and exclusion rules), and your study timeline. For studies that don?\215t include human subjects, include information about how you will collect samples, duration of data gathering efforts, source or location of samples, or batch numbers you will use.",
...
"", "Enter your response here.", "", "", "## Sample size rationale",
...
"", "Enter your response here.", "", "", "## Stopping rule",
...
"", "Enter your response here.", "", "", "", "# Variables", "<!-- In this section you can describe all variables (both manipulated and measured variables) that will later be used in your confirmatory analysis plan. In your analysis plan, you will have the opportunity to describe how each variable will be used. If you have variables which you are measuring for exploratory analyses, you are not required to list them, though you are permitted to do so. -->",
"", "", "## Manipulated variables", "<!-- Describe all variables you plan to manipulate and the levels or treatment arms of each variable. This is not applicable to any observational study. For any experimental manipulation, you should give a precise definition of each manipulated variable. This must include a precise description of the levels at which each variable will be set, or a specific definition for each categorical treatment. For example, ?\200?loud or quiet,?\200\235 should instead give either a precise decibel level or a means of recreating each level. 'Presence/absence' or 'positive/negative' is an acceptable description if the variable is precisely described.",
...
"", "Example: The single outcome variable will be the perceived tastiness of the single brownie each participant will eat. We will measure this by asking participants ?\200\230How much did you enjoy eating the brownie?\200\231 (on a scale of 1-7, 1 being 'not at all', 7 being 'a great deal') and 'How good did the brownie taste' (on a scale of 1-7, 1 being 'very bad', 7 being 'very good'). -->",
"", "Enter your response here.", "", "", "## Indices", "<!-- If any measurements are  going to be combined into an index (or even a mean), what measures will you use and how will they be combined? Include either a formula or a precise description of your method. If your are using a more complicated statistical method to combine measures (e.g. a factor analysis), you can note that here but describe the exact method in the analysis plan section.",
"", "If you are using multiple pieces of data to construct a single variable, how will this occur? Both the data that are included and the formula or weights for each measure must be specified. Standard summary statistics, such as \"means\" do not require a formula, though more complicated indices require either the exact formula or, if it is an established index in the field, the index must be unambiguously defined. For example, \"biodiversity index\" is too broad, whereas \"Shannon?\200\231s biodiversity index\" is appropriate.",
"", "Example: We will take the mean of the two questions above to create a single measure of 'brownie enjoyment.'  -->",
"", "Enter your response here.", "", "", "# Analysis Plan", "<!-- You may describe one or more confirmatory analysis in this preregistration. Please remember that all analyses specified below must be reported in the final article, and any additional analyses must be noted as exploratory or hypothesis generating.",
...
"- If you are going to perform a sequential analysis and check after 50, 100, and 150 samples, you must also specify the p-values you?\200\231ll test against at those three points.",
...
"", "Enter your response here.", "", "", "## Transformations",
...
"", "Enter your response here.", "", "", "## Inference criteria",
"<!-- What criteria will you use to make inferences? Please describe the information you?\215ll use (e.g. p-values, bayes factors, specific model fit indices), as well as cut-off criterion, where appropriate. Will you be using one or two tailed tests for each of your analyses? If you are comparing multiple conditions or testing multiple hypotheses, will you account for this?",
...
"", "", "## Data exclusion", "<!-- How will you determine what data or samples, if any, to exclude from your analyses? How will outliers be handled? Will you use any awareness check? Any rule for excluding a particular set of data is acceptable. One may describe rules for excluding a participant or for identifying outlier data.",
...
"", "Enter your response here.", "", "", "## Exploratory analyses (optional)",
...
"", "Enter your response here.", "", "", "# Other", "", "## Other (Optional)",
...
"", "Enter your response here.", "", "", "# References", "## ",
"\\vspace{-2pc}", "\\setlength{\\parindent}{-0.5in}", "\\setlength{\\leftskip}{-1in}",
"\\setlength{\\parskip}{8pt}", "\\noindent")
  # End prereg
  writeLines(prereg, con = file.path(path, "preregistration.Rmd"))
