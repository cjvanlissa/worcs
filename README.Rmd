...
The `worcs` package is open to contributions from collaborators with valuable expertise, to improve both the workflow and the software. Relevant contributions warrant coauthorship to the package. Please contact the lead author at [c.j.vanlissa@uu.nl](mailto:c.j.vanlissa@uu.nl), or:
