...
<!-- If you are not familiar with these tools, you can download the project repository from the remote repository through the web interface. **Note however that a repository downloaded via the GitHub interface is no longer, itself, a Git repository! This is a peculiarity of the GitHub interface.** -->
