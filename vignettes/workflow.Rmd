...
12. <!--S: Optional: Add a WORCS-badge to your README file and complete the optional elements of the WORCS checklist to qualify for a "Perfect" rating-->Run the `check_worcs()` function to see whether your project adheres to the WORCS checklist (see `worcs::checklist`)
