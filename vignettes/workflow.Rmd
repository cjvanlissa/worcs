...
5. <!--S: Optional: Upload the preregistration to a dedicated preregistration server-->Optional: Render the preregistration to PDF, and upload it as an attachment to a dedicated preregistration server like AsPredicted.org or OSF.io
    ...
    + Optional: Generate a DOI for the preregistration through [the OSF](https://osf.io/) or a service like [Zenodo](https://zenodo.org/)
...
16. <!--S: Generate a Digital Object Identifier (DOI) for the project on [OSF](https://osf.io/)-->
Generate a Digital Object Identifier (DOI) for the project on [OSF](https://osf.io/)
    ...
    + Alternatively, you can connect your 'Git' remote repository to [Zenodo](https://zenodo.org/), instead of the OSF, to create DOIs for the project and specific resources.
