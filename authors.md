...
- **Aaron Peikert**. Author. [](https://orcid.org/0000-0001-7813-818X)

- **Andreas M. Brandmaier**. Author.
...
Reproducible Code in Science*. R package version 0.1.21.1,
<https://github.com/cjvanlissa/worcs>.
    ...
    @Manual{,
      ...
      year = {2026},
      note = {R package version 0.1.21.1},
