...
Third, R is well-supported; a vibrant online community exists for R, developing new R methods and packages, and providing support and tutorials for existing ones.
...
Moreover, wrappers are available for many tools developed in other programming languages, and code written in other programming languages can be evaluated from R [including C++, Fortran, and Python, @allaireMarkdownPythonEngine].
