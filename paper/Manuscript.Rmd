...
(https://github.com; other similar services include 'GitLab', https://gitlab.com
and 'Bitbucket', https://bitbucket.org). 'GitHub' is best understood as a cloud
...
ability to revert to a previous state of the project, or to merge the 
experimental branch.
