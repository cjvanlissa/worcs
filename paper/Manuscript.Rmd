...
If data cannot be shared, researchers should aim to safeguard the potential for computational reproducibility and secondary analysis as much as possible. The `worcs` package uses two solutions to accomplish this goal.
The first solution is to publish a *checksum* of the original data file.
Think of a checksum as a 32-character summary of the contents of a file, or alternatively, a "one word" description of the file.
