...
that is conceptually and practically compatible with WORCS
was recently introduced by @peikertReproducibleDataAnalysis2019.
However, it is somewhat difficult to set up for novice users. 
The `R` package `repro`
is currently in development to facilitate adoption [@repro]. 
Another 
