...
See Figure 1 for a schematic overview of the conceptual workflow,
which shows the steps to take in different stages of the research process.
The workflow is elaborated in greater detail below.
...
The workflow further recommends that users create a project page on the Open Science Framework – a recognized repository in the social sciences – and generate a DOI for this project.
Additional DOIs can be generated through the OSF for specific resources, such as data sets.
It is additionally or alternatively possible to connect the GitHub repository to Zenodo, which also offers DOIs and allows users to document projects with extensive metadata.
