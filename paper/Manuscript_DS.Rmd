...
author:
  name: |
    [Caspar J. Van Lissa](c.j.vanlissa@uu.nl)$^{a,b}$
    Andreas M. Brandmaier$^{c,d}$
    Loek Brinkman$^{b,e}$
    Anna-Lena Lamprecht$^{b,f}$
    Aaron Peikert$^{c}$
    Marijn E. Struiksma$^{b,g}$
    Barbara Vreede$^{h}$
    
  affiliation: | 
      $a$: Utrecht University faculty of Social and Behavioral Sciences, department of Methodology & Statistics  
      ...
      $e$: UMC Utrecht  
      $f$: Utrecht University, Department of Information and Computing Sciences  
      $g$: Utrecht University faculty of Humanities, department of Language, Literature & Communication, Utrecht Institute of Linguistics OTS  
      $h$: University Library Utrecht
